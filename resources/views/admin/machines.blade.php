                            ...
                            <div class="portlet box green">
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="caption">
                                        ...
                                        <i class="fa fa-globe"></i>All Machines </div>
                                        ...
                                        <tbody>
                                           ...
                                           @foreach ($machines as $machine)
                                            ...
                                            <tr>
                                                ...
                                                <td class="all"> {{ $machine ->serial_no}}</td>

                             

                                                <td class="none">{{ $machine ->type}}</td>

                                               

                                             <!--     <td class="none">{{ $machine ->default_location}}</td>

                                                <td class="none">{{ $machine ->last_modified_on}}</td>-->

                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i>All Location </div>
                                    <div class="tools">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_3" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                           @foreach ($locations as $location)
                                            <tr>
                                                <td class="all"> {{ $location ->id}}</td>
                                                <td class="none">{{ $location ->name}}</td>
                                               
                                             <!--     <td class="none">{{ $location ->default_location}}</td>
                                                <td class="none">{{ $location ->last_modified_on}}</td>-->
                                           </tr>
                                         @endforeach 
                                        </tbody> 
                                    </table>

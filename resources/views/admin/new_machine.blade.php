                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                ...
                                <div class="portlet-title">
                                    ...
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase">New Machine</span>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                  ...
                                                  {!! Form::text('serial_no', $value=old('wallet_name'),['data-required'=>'1','class'=>'form-control','required'=>'required']) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                  ...
                                                  {!! Form::select('type', $type,$value=old('type'),['data-required'=>'1','class'=>'form-control','required'=>'required']) !!}

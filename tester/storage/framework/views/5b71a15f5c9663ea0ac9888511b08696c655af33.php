                                    ...
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_3" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                           <?php $__currentLoopData = $allusers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alluser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($alluser->surname); ?> <?php echo e($alluser->name); ?> <?php echo e($alluser->lastname); ?></td>
                                                <td><?php echo e($alluser->email); ?></td>
                                                <td><?php echo e($alluser->mobile_no); ?></td>
                                                <td>
                                               <?php if($alluser->status==1): ?>
                                                ...
                                                <td><a class="btn btn-danger " href="<?php echo e(url('admin/user/')); ?>/<?php echo e($alluser->id); ?>">View</a></td>
                                           </tr>

...
<div class="page-content-wrapper">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
       <?php echo Form::text('repayment_duration', $value = $app_datas->repayment_duration , $attributes = ['class'=>'  form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'Repayment Duration'   ,'readonly'=>'readonly']); ?> 
        <?php if($errors->has('repayment_duration')): ?>
                            <span class="help-block">
                                <strong><?php echo e($errors->first('repayment_duration')); ?></strong>
                            </span>
         <?php endif; ?> 
        </div>
    </div>
...
<div class="panel panel-default">
 ...
 <div class="form-group<?php echo e($errors->has('signature') ? ' has-error' : ''); ?>">
      ...
      <div class="form-group">
        ...
        <div class="col-md-9">
       <?php echo Form::text('cash_loan_of', $value =$app_datas->cash_loan_of , $attributes = ['class'=>'  form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'Thrift loan of' ,'readonly'=>'readonly'  ]); ?> 
        <?php if($errors->has('Cash loan of')): ?>
                            <span class="help-block">
                                <strong><?php echo e($errors->first('cash_loan_of')); ?></strong>
                            </span>
         <?php endif; ?> 
        </div>
    </div>
     ...
     <div class="form-group">
        ...
        <div class="col-md-4">
       <?php echo Form::text('cash_loan_of_n', $value =$app_datas->cash_loan_of_n  , $attributes = ['class'=>'  form-control number form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'(=N=)' ,'readonly'=>'readonly'  ]); ?> 
        <?php if($errors->has('cash_loan_of_n')): ?>
                            <span class="help-block">
                                <strong><?php echo e($errors->first('cash_loan_of_n')); ?></strong>
                            </span>
         <?php endif; ?> 
        </div>
    </div>

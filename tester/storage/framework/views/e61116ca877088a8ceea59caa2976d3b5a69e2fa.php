                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span>Approver : <?php echo e(isset($approvers->name) ? $approvers->name : 'New'); ?></span>
                            </li>
                        </ul>
                    ...
                    <!-- BEGIN PAGE TITLE-->
                     <h3 class="page-title"> Approver :
                        <small> <?php echo e(isset($approvers->name) ? $approvers->name : 'New'); ?></small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                    <div class="row">
...
<div class="form-group">
        ...
        <div class="col-md-4">
        <?php echo Form::text('name', $value=isset($approvers->name)?$approvers->name:old('name'),['data-required'=>'1','class'=>'form-control','required'=>'required']); ?>
...
<div class="form-group">
        ...
        <div class="col-md-4">
        <?php echo Form::text('middle_name', $value=isset($approvers->middle_name)?$approvers->middle_name:old('middle_name'),['class'=>'form-control']); ?>
...
<div class="form-group">
        ...
        <div class="col-md-4">
        <?php echo Form::text('lastname', $value=isset($approvers->lastname)?$approvers->lastname:old('lastname'),['data-required'=>'1','class'=>'form-control','required'=>'required']); ?>
...
<div class="form-group">
      ...
      <?php echo Form::text('email', $value=isset($approvers->email)?$approvers->email:old('email'),['data-required'=>'1',isset($approvers->email)?'readonly':'' =>isset($approvers->email)?'readonly':''  ,   'class'=>'form-control','required'=>'required']); ?>
...
<div class="form-group">
        ...
        <div class="col-md-4">
     <?php echo Form::text('mobile_no', $value=isset($approvers->mobile_no)?$approvers->mobile_no:old('mobile_no'),['data-required'=>'1','class'=>'form-control number','autocomplete'=>'off','required'=>'required' ]); ?>
...
<div class="form-group">
        ...
        <div class="col-md-4">
        <?php echo Form::select('role',[''=>'','1'=>'admin','2'=>'Approver'], $value=isset($approvers->mobile_no_country)?$approvers->role:old('role'),['data-required'=>'1','class'=>'form-control number','autocomplete'=>'off','required'=>'required']); ?>

...
<div class="col-md-12">  
    <div class="col-md-6">  
<a target="_blank" href="<?php echo e(url('direct_debit_authorization_pdf/'.$loan_application['id'])); ?>" class="btn btn-success">Print Direct Debit Authorization  </a>
    </div>
    <div class="col-md-6">  
<a target="_blank" href="<?php echo e(url('application_package_print/'.$loan_application['id'])); ?>" class="btn btn-success">Print Application Package </a>
    </div>
</div>

...
<div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                             <?php echo Form::open(['id'=>'','class'=>'form-horizontal','method'=>'post','files'=>true]); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
       <?php echo Form::text('name', $value = ($user->surname).' '.($user->name).' '.($user->lastname) , $attributes = ['class'=>'form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'Full Name' ,'readonly'=>'readonly']); ?> 
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
       <?php echo Form::text('company', $value = old('company') , $attributes = ['class'=>'form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'Company'  ]); ?> 
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
       <?php echo Form::text('dept_location', $value = old('dept_location') , $attributes = ['class'=>'form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'Dept. / Location'  ]); ?> 
   ...
   <div class="form-group">
        ...
        <div class="col-md-4">
       <?php echo Form::text('user_id', $value = $user->id , $attributes = ['class'=>'form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'Employee Sharp ID' ,'readonly'=>'readonly' ]); ?> 
        </div>
    </div>
   ...
   <div class="form-group">
        ...
        <div class="col-md-4">
       <?php echo Form::text('gsm_number', $value = '+'.($user->mobile_no_country).' '.($user->mobile_no) , $attributes = ['class'=>'form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'GSM number' ,'readonly'=>'readonly' ]); ?> 
        </div>
    </div>
       ...
       <div class="form-group">
        ...
        <div class="col-md-4">
       <?php echo Form::text('tel_ext', $value =  $user->office_extension , $attributes = ['class'=>'form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'Employee Sharp ID' ,'readonly'=>'readonly' ]); ?> 
        </div>
    </div>
       ...
       <div class="form-group">
        ...
        <div class="col-md-4">
       <?php echo Form::text('address', $value = $user->address , $attributes = ['class'=>'form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'Employee Sharp ID' ,'readonly'=>'readonly' ]); ?> 
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
       <?php echo Form::text('amount_in_words', $value = old('amount_in_words') , $attributes = ['class'=>'form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'Amount Requested in Words'  ]); ?> 
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
       <?php echo Form::text('amount_in_figure', $value = old('amount_in_figure') , $attributes = ['class'=>' number form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'Amount in figures (=N=)'  ]); ?> 
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
       <?php echo Form::text('tenor', $value = old('tenor') , $attributes = ['class'=>'  form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'tenor'  ]); ?> 
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
       <?php echo Form::text('purpose_for_cash_request', $value = old('purpose_for_cash_request') , $attributes = ['class'=>'  form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'purpose_for_cash_request'  ]); ?> 
 ...
 <div class="form-group<?php echo e($errors->has('signature') ? ' has-error' : ''); ?>">
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                            ...
                            <?php if(isset($user->signature)): ?>
                            <img src="<?php echo e(url('public/images/'.$user->signature)); ?>" alt="" /> 
                            <?php else: ?> 
                        ...
                        <div>
                            <span class="btn default btn-file">
                                ...
                                <?php echo Form::file('signature', array('class' => 'form-control')); ?>
      ...
      <div class="form-group">
        ...
        <div class="col-md-9">
       <?php echo Form::text('thrift_loan_of', $value = old('thrift_loan_of') , $attributes = ['class'=>'  form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'Thrift loan of'  ]); ?> 
     ...
     <div class="form-group">
        ...
        <div class="col-md-4">
       <?php echo Form::text('thrift_loan_of_n', $value = old('thrift_loan_of_n') , $attributes = ['class'=>'  form-control number form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'(=N=)'  ]); ?> 
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
       <?php echo Form::text('deduction_amount', $value = old('deduction_amount') , $attributes = ['class'=>'  form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'deduction amount'  ]); ?> 
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
       <?php echo Form::text('deduction_amount_n', $value = old('deduction_amount_n') , $attributes = ['class'=>'  form-control number form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'(=N=)'  ]); ?> 
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
       <?php echo Form::text('salary_monthly', $value = old('salary_monthly') , $attributes = ['class'=>'  form-control number form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'No of instasllments'  ]); ?> 
  ...
  <div class="form-group">
    ...
    <div class="col-md-3">
        <div class="input-group input-medium date date-picker" data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
            <input value= "<?php echo e(old('effect_from')); ?>" type="text" name="effect_from" class="form-control" readonly>

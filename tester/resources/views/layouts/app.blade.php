...
<html lang="{{ config('app.locale') }}">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Procoop |  
        {{ Request::segment(1) === 'register' ? 'User Registration' : '' }}  
        {{ Request::segment(1) === 'login' ? 'User login' : '' }}  
        {{ Request::segment(1) === 'verify' ? 'User Registration - Verification' : '' }}  
          </title>
    ...
    <body class=" login">
        ...
        {!! HTML::script(url('/public/assets/global/scripts/app.min.js')); !!}
         ...
         <!-- BEGIN PAGE LEVEL SCRIPTS -->
           ...
           {!! HTML::script(url('/public/assets/global/plugins/jquery-inputmask/jquery.inputmask.bundle.min.js')); !!}
            {!! HTML::script(url('/public/assets/global/plugins/jquery.input-ip-address-control-1.0.min.js')); !!}
            ...
            form.validate({
                ...
                rules: {
                    ...
                    email: {
                        required: true,
                        email: true,
                        pattern: '(.+@+[A-Za-z0-9._-]+\\.{{$company_domain_name["pvalue"]}}$)|(.+{{"@".$company_domain_name["pvalue"]}}$)',
                        },
                    office_extension: {
                        required: true,
                        pattern: '[0-9]{5}',
                ...
                messages: { // custom messages for radio buttons and checkboxes
                    ...
                    email: {
                        ...
                        pattern: "Please Enter a valid email, having domain {{'@'.$company_domain_name['pvalue']}}",
                    },
                     office_extension: {

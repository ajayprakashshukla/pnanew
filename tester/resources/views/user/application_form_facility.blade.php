...
<div class="page-content-wrapper">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapse_1"> 1. MEMBER’S DETAILS 
                                                    <small class="help-block" style="display: inline;">(All fields are required)</small></a>
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
       {!! Form::text('repayment_duration', $value = old('repayment_duration') , $attributes = ['class'=>'  form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'Repayment Duration'  ]) !!} 
...
<div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapse_4"> 4. Upload Files: <small class="help-block" style="display: inline;">(Please uplode atleast a single document for identityfication)</small> </a>
                </h4>
            </div>
...
<div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapse_6"> 5. Upload Signature: <small class="help-block" style="display: inline;">(Please uplode your latest signature a)</small> </a>
                </h4>
            </div>
 ...
 <div class="form-group{{ $errors->has('signature') ? ' has-error' : '' }}">
                    ...
                    @if ($errors->has('signature'))
                     ...
                     @endif
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion1" href="#collapse_5"> 6. AUTHORIZATION TO DEDUCT:  <small class="help-block" style="display: inline;">(All fields are required)</small></a>
                                                </h4>
                                            </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-9">
       {!! Form::text('cash_loan_of', $value = old('cash_loan_of') , $attributes = ['class'=>'  form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'Thrift loan of'  ]) !!} 
     ...
     <div class="form-group">
        ...
        <div class="col-md-4">
       {!! Form::text('cash_loan_of_n', $value = old('cash_loan_of_n') , $attributes = ['class'=>'  form-control number form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'(=N=)'  ]) !!} 

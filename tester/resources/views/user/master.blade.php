                ...
                <div class="top-menu">
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                           ...
                           @if(isset($user->img))
                            <img src="{{url('public/upload/'.App\Common\Common::getFile(['id'=>$user->img]))}}" alt=""  class="img-circle" /> 
                            @else 
                            <img src="{{url('/public/images/avtar.png')}}" alt="" class="img-circle" /> 
                            @endif
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item  ">
                            <a href="{{url('wallet_summary')}}/1" class="nav-link nav-toggle">
                        ...
                        <li class="nav-item  ">
                            <a href="{{url('loans')}}" class="nav-link nav-toggle">
                        ...
                        <li class="nav-item  ">
                            <a href="{{url('wallet_summary')}}/2" class="nav-link nav-toggle">
                                <i class="icon-bulb"></i>
                                <span class="title">Loans</span>
                                <span class="arrow"></span>
                            </a>
                        ...
                        <li class="nav-item  ">
                            <a href="{{url('wallet_summary')}}/3" class="nav-link nav-toggle">
                                <i class="icon-bulb"></i>
                        ...
                        <li class="nav-item  ">
                            <a href="{{url('wallet_summary')}}/4" class="nav-link nav-toggle">
                                <i class="icon-bulb"></i>
                        ...
                        <li class="nav-item  ">
                            <a href="{{url('newapplication')}}" class="nav-link nav-toggle">
                        ...
                        <li class="nav-item  ">
                            <a href="{{url('application/loans')}}" class="nav-link nav-toggle">
                          ...
                          <li class="nav-item  ">
                          <a href="{{url('application/facility')}}" class="nav-link nav-toggle">
                        ...
                        <li class="nav-item  ">
                            <a href="{{url('application/projects')}}" class="nav-link nav-toggle">
...
.smetext {
 ...
 @if(Request::segment(1) == 'newapplication' && Request::segment(2) !='')                                                  

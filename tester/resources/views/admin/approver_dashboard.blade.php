                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark bold uppercase">Loans</span>
                                    </div>
                                </div>
                                ...
                                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                           @foreach ($loans_data as $loans_datas)
                                            <tr>
                                                <td>{{ $loans_datas->facilities_name  }}</td>
                                                <td>{{ $loans_datas->facility_category_name  }}</td>

                                                <td>{{ $loans_datas->user_name  }}</td>
                                                
                                                
                                                <td><a class="btn btn-danger " href="{{url('admin/view_application')}}/{{ $loans_datas->id  }}">View</a></td>
                                           </tr>
                                         @endforeach
                                        </tbody>
                                    </table>
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body"> 
                                 <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                           @foreach ($facility_data as $facility_datas)
                                            <tr>
                                                <td>{{ $facility_datas->facilities_name  }}</td>
                                                <td>{{ $facility_datas->facility_category_name  }}</td>

                                                <td>{{ $facility_datas->user_name  }}</td>
                                                
                                                
                                                <td><a class="btn btn-danger " href="{{url('admin/view_application')}}/{{ $facility_datas->id  }}">View</a></td>
                                           </tr>
                                         @endforeach
                                        </tbody>
                                    </table>
                          ...
                          <div class="col-md-6 col-sm-6">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body"><table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th class="all">Facility Name</th>
                                                <th class="all">Facility Category</th>
                                        ...
                                        <tbody>
                                           @foreach ($project_data as $project_datas)
                                            <tr>
                                                <td>{{ $project_datas->facilities_name  }}</td>
                                                <td>{{ $project_datas->facility_category_name  }}</td>

                                                <td>{{ $project_datas->user_name  }}</td>
                                                
                                                
                                                <td><a class="btn btn-danger " href="{{url('admin/view_application')}}/{{ $project_datas->id  }}">View</a></td>
                                           </tr>
                                         @endforeach
                                        </tbody>
                                    </table>

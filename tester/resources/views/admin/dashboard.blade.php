            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"> Dashboard
                        <img src="{{url('public/images/ngn.png')}}" style="float: right">
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 blue" href="#">
                                ...
                                <div class="details">
                                    <div class="number">
                                        <span data-counter="counterup" data-value="{{$no_of_members}}"></span>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 red" href="#">
                                ...
                                <div class="details">
                                    <div class="number">
                                        <span data-counter="counterup" data-value=" {{number_format($wallet_amounts[3],2)}}"></span> </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 green" href="#">
                                ...
                                <div class="details">
                                    <div class="number" >
                                        <span data-counter="counterup" data-value="{{number_format($total_loan_amount,2)}}"></span>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 purple" href="#">
                                ...
                                <div class="details">
                                    <div class="number">
                                        <span data-counter="counterup" data-value=" {{number_format($total_revenue,2)}}"></span> </div>
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <div id="site_statistics_loading">
                                        <img src="{{url('public/assets/global/img/loading.gif')}}" alt="loading" /> </div>
...
<table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_3" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                           @foreach ($revenues as $revenue)
                                            <tr>
                                                <td>{{ date('Y-m-d',strtotime($revenue->dates) )}}</td>

                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span>Wallet : {{$wallet['wallet_name'] or 'New'}}</span>
                            </li>
                        </ul>
...
<div class="form-group">
        ...
        <div class="input-group input-medium date date-picker col-md-4" data-date="" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                    <input value= "{{date('Y-m-d',strtotime($wallet['creation_date']))}}" type="text" name="creation_date" class="form-control" readonly>
...
<div class="form-group">
        ...
        <div class="col-md-4">
        {!! Form::text('wallet_name', $value=isset($wallet->wallet_name)?$wallet->wallet_name:old('wallet_name'),['data-required'=>'1','class'=>'form-control','required'=>'required']) !!}
    </div>
</div>
...
<div class="form-group">
        ...
        <div class="col-md-4">
        {!! Form::text('wallet_type', $value=isset($wallet->wallet_type)?$wallet->wallet_type:old('wallet_type'),['data-required'=>'1','class'=>'form-control','required'=>'required']) !!}
    </div>
</div>
...
<div class="form-group">
      ...
      {!! Form::text('company_email', $value=isset($wallet->company_email)?$wallet->company_email:old('company_email'),['data-required'=>'1' ,   'class'=>'form-control','required'=>'required']) !!}
    </div>
</div>
...
<div class="form-group">
      ...
      {!! Form::text('sharp_id', $value=isset($wallet->sharp_id)?$wallet->sharp_id:old('sharp_id'),['data-required'=>'1',   'class'=>'form-control','required'=>'required']) !!}
    </div>
</div>
...
<div class="form-group">
      ...
      {!! Form::text('monthly_payment', $value=isset($wallet->monthly_payment)?$wallet->monthly_payment:old('monthly_payment'),['data-required'=>'1',   'class'=>'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
      ...
      {!! Form::text('quarterly_payment', $value=isset($wallet->quarterly_payment)?$wallet->quarterly_payment:old('quarterly_payment'),['data-required'=>'1',   'class'=>'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
      ...
      {!! Form::text('annual_payment', $value=isset($wallet->annual_payment)?$wallet->annual_payment:old('annual_payment'),['data-required'=>'1',   'class'=>'form-control']) !!}
    </div>
</div>
<div class="form-group">
      ...
      {!! Form::text('wallet_balance', $value=isset($wallet->wallet_balance)?$wallet->wallet_balance:old('wallet_balance'),['data-required'=>'1',   'class'=>'form-control','required'=>'required']) !!}
    </div>
</div>

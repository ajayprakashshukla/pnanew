...
<div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span>FACILITY :{{ $facility_detail->name or 'New' }}</span>
                            </li>
                        </ul>
                       
                    </div>
                    <h3 class="page-title"> FACILITY
                        <small>{{ $facility_detail->name or 'New' }}</small>
                    </h3>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase">{{ $facility_detail->name or 'New Facility' }} Facility</span>
                                    </div>
                                    ...
                                    {!! Form::open(['id'=>'form_sample_3','class'=>'form-horizontal','method'=>'post'])!!}
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-md-4">
                                                  {!! Form::text('name', $value=isset($facility_detail->name)?$facility_detail->name:old('name'),['data-required'=>'1','class'=>'form-control','required'=>'required']) !!}
                                                </div>
                                                     @if ($errors->has('name'))
                                            ...
                                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-md-4">
                                                  {!! Form::text('description', $value=isset($facility_detail->description)?$facility_detail->description:old('description'),['data-required'=>'1','class'=>'form-control','required'=>'required']) !!}
                                                </div>
                                            ...
                                            <div class="form-group{{ $errors->has('facility_category') ? ' has-error' : '' }}">
                                               ...
                                               @foreach ($facility_categories as $facility_category) 
                                                        <label>
                                                        {!! Form::radio('facility_categories', $facility_category->id, isset($facility_detail->facility_categories)? $facility_detail->facility_categories :old('facility_categories'),['required'=>'required'] ) !!}{{$facility_category->name}}
                                                        </label>
                                                    @endforeach
                                                    </div>
                                                    @if ($errors->has('facility_category'))
                                                    <span class="help-block">
                                                                        <strong>{{ $errors->first('facility_category') }}</strong>
                                                                    </span>
                                                     @endif
                                                </div>
                                            </div>
                                            <div class="form-group{{ $errors->has('min_amount') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-md-4">
                                                  {!! Form::text('min_amount', $value=isset($facility_detail->min_amount)?$facility_detail->min_amount:old('min_amount'),['data-required'=>'1','class'=>'form-control number','required'=>'required']) !!}
                                                </div>
                                             ...
                                             <div class="form-group{{ $errors->has('max_amount') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-md-4">
                                                  {!! Form::text('max_amount', $value=isset($facility_detail->max_amount)?$facility_detail->max_amount:old('max_amount'),['data-required'=>'1','class'=>'form-control number','required'=>'required']) !!}
                                                </div>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                 {!! Form::select('interest_rate',[''=>'']+$percent,
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                 {!! Form::select('maximum_tenor',[''=>'']+$years,
                                                  isset($facility_detail->maximum_tenor)?$facility_detail->maximum_tenor:old('maximum_tenor')
                                                 ,['data-required'=>'1','class'=>'form-control select2me','required'=>'required'])!!}
                                                </div>
                                                @if ($errors->has('maximum_tenor'))
                                                    <span class="help-block">
                                                                        <strong>{{ $errors->first('maximum_tenor') }}</strong>
                                                                    </span>
                                                     @endif
                                            </div>
                                         ...
                                         <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                 {!! Form::select('payment_schedule[]',[''=>'']+$payment_schedule->toArray() ,
                                                ...
                                                @if ($errors->has('payment_schedul'))
                                                    <span class="help-block">
                                                                        <strong>{{ $errors->first('payment_schedul') }}</strong>
                                                                    </span>
                                                     @endif
                                            </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                 {!! Form::select('monthly_payment_date',[''=>'']+$date,
                                                   isset($facility_detail->monthly_payment_date)?$facility_detail->monthly_payment_date:old('monthly_payment_date')
                                                 ,['data-required'=>'1','class'=>'form-control select2me','required'=>'required'])!!}
                                                </div>
                                                @if ($errors->has('monthly_payment_date'))
                                                    <span class="help-block">
                                                                    <strong>{{ $errors->first('monthly_payment_date') }}
                                                                    </strong>
                                                                    </span>
                                                     @endif
                                            </div>
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-4 quarterly_payment" >
                                                     <div class="col-md-12 quarterly_payment_div">
                                                        ...
                                                        <div class="col-md-5">
                                                              {!! Form::select('quarterly_payment_month_1',[''=>'']+$month,
                                                    ...
                                                    @if ($errors->has('quarterly_payment_month_1'))
                                                    <span class="help-block">
                                                                    <strong>{{ $errors->first('quarterly_payment_month_1') }}
                                                                    </strong>
                                                                    </span>
                                                     @endif
                                                        </div>
                                                        <div class="col-md-5">
                                                              {!! Form::select('quarterly_payment_date_1',[''=>'']+$date,
                                                isset($quarterly_payment_date['quarterly_payment_date_1'])?$quarterly_payment_date['quarterly_payment_date_1']:old('quarterly_payment_date_1')
                                                 ...
                                                 @if ($errors->has('quarterly_payment_date_1'))
                                                    <span class="help-block">
                                                                    <strong>{{ $errors->first('quarterly_payment_date_1') }}
                                                                    </strong>
                                                                    </span>
                                                     @endif
                                                        </div>
                                                     ...
                                                     <div class="col-md-12 quarterly_payment_div">
                                                        ...
                                                        <div class="col-md-5">
                                                              {!! Form::select('quarterly_payment_month_2',[''=>'']+$month,
                                                 ...
                                                 ,['data-required'=>'1','class'=>'form-control select2me','required'=>'required'])!!}
                                                    ...
                                                    @if ($errors->has('quarterly_payment_month_2'))
                                                    <span class="help-block">
                                                                    <strong>{{ $errors->first('quarterly_payment_month_2') }}
                                                                    </strong>
                                                                    </span>
                                                     @endif
                                                        </div>
                                                        <div class="col-md-5">
                                                              {!! Form::select('quarterly_payment_date_2',[''=>'']+$date,
                                                ...
                                                ,['data-required'=>'1','class'=>'form-control select2me','required'=>'required','placeholder'=>'Month'])!!}
                                                 ...
                                                 @if ($errors->has('quarterly_payment_date_2'))
                                                    <span class="help-block">
                                                                    <strong>{{ $errors->first('quarterly_payment_date_2') }}
                                                                    </strong>
                                                                    </span>
                                                     @endif
                                                        </div>
                                                     ...
                                                     <div class="col-md-12 quarterly_payment_div">
                                                        ...
                                                        <div class="col-md-5">
                                                              {!! Form::select('quarterly_payment_month_3',[''=>'']+$month,
  isset($quarterly_payment_date['quarterly_payment_month_3'])?$quarterly_payment_date['quarterly_payment_month_3']:old('quarterly_payment_month_3')
                                                 ...
                                                 ,['data-required'=>'1','class'=>'form-control select2me','required'=>'required'])!!}
                                                    ...
                                                    @if ($errors->has('quarterly_payment_month_3'))
                                                    <span class="help-block">
                                                                    <strong>{{ $errors->first('quarterly_payment_month_3') }}
                                                                    </strong>
                                                                    </span>
                                                     @endif
                                                        </div>
                                                        <div class="col-md-5">
                                                              {!! Form::select('quarterly_payment_date_3',[''=>'']+$date,
  isset($quarterly_payment_date['quarterly_payment_date_3'])?$quarterly_payment_date['quarterly_payment_date_3']:old('quarterly_payment_date_3')
                                                 ...
                                                 @if ($errors->has('quarterly_payment_date_3'))
                                                    <span class="help-block">
                                                                    <strong>{{ $errors->first('quarterly_payment_date_3') }}
                                                                    </strong>
                                                                    </span>
                                                     @endif
                                                        </div>
                                                      ...
                                                      <div class="col-md-12 quarterly_payment_div">
                                                        ...
                                                        <div class="col-md-5">
                                                              {!! Form::select('quarterly_payment_month_4',[''=>'']+$month,
  isset($quarterly_payment_date['quarterly_payment_month_4'])?$quarterly_payment_date['quarterly_payment_month_4']:old('quarterly_payment_month_4')
                                                 ...
                                                 ,['data-required'=>'1','class'=>'form-control select2me','required'=>'required'])!!}
                                                    ...
                                                    @if ($errors->has('quarterly_payment_month_4'))
                                                    <span class="help-block">
                                                                    <strong>{{ $errors->first('quarterly_payment_month_4') }}
                                                                    </strong>
                                                                    </span>
                                                     @endif
                                                        </div>
                                                        <div class="col-md-5">
                                                              {!! Form::select('quarterly_payment_date_4',[''=>'']+$date,
                                                 ...
                                                 @if ($errors->has('quarterly_payment_date_4'))
                                                    <span class="help-block">
                                                                    <strong>{{ $errors->first('quarterly_payment_date_4') }}
                                                                    </strong>
                                                                    </span>
                                                     @endif
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                  <div class="col-md-12 quarterly_payment_div">
                                                        <div class="col-md-5">
                                                              {!! Form::select('annual_payment_month',[''=>'']+$month,
                                                   isset($annual_payment_month)?$annual_payment_month:old('annual_payment_month')

                                               ,['data-required'=>'1','class'=>'form-control select2me','required'=>'required'])!!}
                                                    
                                                    @if ($errors->has('annual_payment_month'))
                                                    <span class="help-block">
                                                                    <strong>{{ $errors->first('annual_payment_month') }}
                                                                    </strong>
                                                                    </span>
                                                     @endif
                                                        </div>
                                                        <div class="col-md-5">
                                                              {!! Form::select('annual_payment_date',[''=>'']+$date,
                                                  isset($annual_payment_date)?$annual_payment_date:old('annual_payment_date')

                                                 ,['data-required'=>'1','class'=>'form-control select2me','required'=>'required','placeholder'=>'Month'])!!}

                                                 @if ($errors->has('annual_payment_date'))
                                                    <span class="help-block">
                                                                    <strong>{{ $errors->first('annual_payment_date') }}
                                                                    </strong>
                                                                    </span>
                                                     @endif
                                                        </div>
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                 {!! Form::select('monthly_interest_payment_date',[''=>'']+$date,
                                                ...
                                                @if ($errors->has('monthly_interest_payment_date'))
                                                    <span class="help-block">
                                                                    <strong>{{ $errors->first('monthly_interest_payment_date') }}
                                                                    </strong>
                                                                    </span>
                                                     @endif
                                            </div>
...
<div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                 {!! Form::select('processing_fee',[''=>'']+$percent,
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                 {!! Form::select('insurance_fee',[''=>'']+$percent,

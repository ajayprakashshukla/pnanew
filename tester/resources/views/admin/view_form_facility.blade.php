...
<div class="page-content-wrapper">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-gift"></i>CASH  LOAN REQUEST FORM </div>
                                    <div class="tools">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
       {!! Form::text('repayment_duration', $value =$app_datas->repayment_duration  , $attributes = ['class'=>'  form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'repayment_duration' ,'readonly'=>'readonly' ]) !!} 
...
<div class="panel panel-default">
 ...
 <div class="form-group{{ $errors->has('signature') ? ' has-error' : '' }}">
      ...
      <div class="form-group">
        ...
        <div class="col-md-9">
       {!! Form::text('cash_loan_of', $value = $app_datas->cash_loan_of  , $attributes = ['class'=>'  form-control form-control-solid placeholder-no-fix', 'autocomplete'=>'off' ,'placeholder'=>'cash_loan_of' ,'readonly'=>'readonly' ]) !!} 
        @if ($errors->has('cash_loan_of'))
                            <span class="help-block">
...
<td></td><td></td><td><input type="submit" class="btn btn-success" value="Save Details"  name="facility"></td></tr>
                           </table>
                    </div>
                    </div>

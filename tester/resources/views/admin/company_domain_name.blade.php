                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                ...
                                <div class="portlet-body">
                                    ...
                                    {!! Form::open(['id'=>'form_sample_3','class'=>'form-horizontal','method'=>'post'])!!}
                                            ...
                                            <div class="form-group{{ $errors->has('company_domain_name') ? ' has-error' : '' }}">
                                                <label class="control-label col-md-3">Domain Name
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
                                                  {!! Form::text('company_domain_name', $value=isset($company_domain_name)?$company_domain_name:old('company_domain_name'),['data-required'=>'1','class'=>'form-control','required'=>'required']) !!}
                                                </div>
                                                 @if($errors->has('company_domain_name'))

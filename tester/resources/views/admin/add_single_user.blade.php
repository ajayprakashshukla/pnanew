                                    ...
                                    {!! Form::open(['id'=>'form_sample_3','class'=>'form-horizontal','method'=>'post','files' => true])!!}
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                <textarea name="company_email" rows="6" data-required="1" class="form-control" required>{{old('company_email')}} </textarea>
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                <textarea name="company_id" rows="6" data-required="1" class="form-control" required>{{old('company_id')}} </textarea>
                                                </div>
                                            </div>
                                        </div>
